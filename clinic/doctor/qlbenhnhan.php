    ...
    <div class="modal" id="sua">
      ...
      <!-- Modal body -->
        ...
        <form action="" method="POST">
                ...
                <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="txtdiachi" minlength="8" maxlength="80" required="required" value="<?php echo $p->laycot("select diachi from benhnhan where id_benhnhan='$layid'") ?>">
                </div>  
                </div>   
      ...
      <!-- Modal footer -->
               <div class="modal-footer">
                 ...
                 <button type="submit" id="nut" name="xoa" value="Xóa" class="btn btn-primary">Xóa</button>
                 <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
               </div>
               </form>
          </div>
    ...
    <?php
        ...
        {   $idsua=$_REQUEST['txtid'];
            ...
            if($idsua>0)
			{
				...
				{  
					header('location:qlbenhnhan.php');
				}
				else
				{
        ...
        case 'Xóa':
        {
            ...
            if($idxoa>0)
            {
				if($p->themxoasua("DELETE from benhnhan where id_benhnhan='$layid' limit 1")==1)
				{
					header('location:qlbenhnhan.php');
				}
				else

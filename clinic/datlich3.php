...
$array_busy = [];
$lichhen = $p->show_lich_hen($_SESSION['id_bacsi'] ?? '');
$lichnghi = $p->show_lich_nghi($_SESSION['id_bacsi'] ?? '');
...
<head>
    ...
    <div class="container mt-1 mb-3">
    	<h3 class="text-center font-weight-bolder mt-4 mb-2">Chọn thời gian khám.</h3>
        ...
        <table class="table table-bordered" id = "calendar">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-2 text-left">
                    ...
                    <input type="hidden" name="id_bacsi" value="<?php //echo $_SESSION['id_bacsi'];?>"> -->
                    
                    <button type="submit" name="datlich" class="btn btn-primary" value="Đặt lịch">Đặt lịch</button>
                </div>
            </div>
            </form>
